...
from superflore.generators.pkgbuild.gen_packages import regenerate_pkg
from superflore.generators.pkgbuild.overlay_instance import RosOverlay
...
def main():
    ...
    parser = get_parser('Deploy ROS packages into ArchLinux')
    ...
    with TempfileManager(args.output_repository_path) as _repo:
        ...
        if not preserve_existing and not args.only:
            pr_comment = pr_comment or (
                'Superflore pkgbuild generator began regeneration of all'
            ...
            pr_comment = pr_comment or (
                'Superflore pkgbuild generator ran update from ROS-Overlay ' +
        ...
        if args.only:
            pr_comment = pr_comment or (
                'Superflore pkgbuild generator began regeneration of ' +
            ...
            for pkg in args.only:
                ...
                try:
                    pkgbuild, deps, version = regenerate_pkg(
                        overlay,
                        pkg,
